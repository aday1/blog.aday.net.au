...
const deployMetaHtml = `<div id="deployMetaBadge" style="position:fixed;right:8px;bottom:8px;z-index:9999;padding:4px 8px;border:1px solid #4cff8a;background:rgba(0,0,0,0.78);color:#b8ffd1;font:11px/1.2 monospace;max-width:85vw;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">deploy metadata loading...</div>
  <script>
    (function () {
